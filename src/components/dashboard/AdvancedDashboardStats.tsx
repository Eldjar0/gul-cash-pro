...
import { TrendingUp, Package, Users, Gift } from 'lucide-react';

export const AdvancedDashboardStats = () => {
  return (
    <div className="grid gap-4 md:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">dont 0 proche péremption</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">0</div>
          <p className="text-xs text-muted-foreground">en attente de réception</p>
        </CardContent>
      </Card>
