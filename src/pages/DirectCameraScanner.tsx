...
import { Camera, X, CheckCircle2, XCircle, Package } from 'lucide-react';
...
export default function DirectCameraScanner() {
  ...
  const [lastScan, setLastScan] = useState<{ barcode: string; success: boolean; productName?: string } | null>(null);
